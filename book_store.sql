...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2020 at 05:04 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `displaybook` ()  NO SQL
SELECT * from book$$
...
--
DELIMITER $$
CREATE TRIGGER `bookcount` AFTER INSERT ON `book` FOR EACH ROW update book_count set b_cnt=b_cnt+1
$$
DELIMITER ;
...
INSERT INTO `book_count` (`b_cnt`) VALUES
(3);
...
(5, 'shreya', 'shreya94185@gmail.com', 'hello');
...
(3, 'Siri', ' cmrit', 560066, 'delhi', 'delhi', 7338330769, 'shreya'),
(4, 'Siri', ' cmrit', 560066, 'delhi', 'delhi', 7338330769, 'shreya'),
(5, 'Pratik', '----------------', 560066, 'bangalore', 'karnataka', 123456789, 'bithu'),
(6, 'siri', ' ratfgvbjkl', 12345, 'bangalore', 'karnataka', 123456789, 'shreya'),
(7, 'siri', ' sfvgf', 12345, 'bangalore', 'karnataka', 123456789, '1234'),
(8, 'siri', ' fsgdgdrgr', 12345, 'bangalore', 'karnataka', 123456789, '1234');
...
INSERT INTO `user` (`u_id`, `u_fnm`, `u_unm`, `u_pwd`, `u_gender`, `u_contact`, `u_city`) VALUES
(1, 'Hiren Bhaliya', 'Hiren', 'hiru', 'Male', '9925136522', 'Rajkot'),
(2, 'Shital', 'shital', 'shital', 'Female', '9985689856', 'Rajkot'),
(3, 'Lina', 'Lina123', '123', 'Female', '9456325663', 'Amreli'),
(4, 'admin', 'admin', 'admin123', 'Female', '9859632561', 'Rajkot'),
(5, 'Kaushik', 'Darcy', '160160160', 'Male', '9016388880', 'Rajkot'),
(6, 'sanjeev', 'kumar', 'sanjeev', 'Male', '9015501897', 'Ahmedabad'),
(7, 'Shreya', 'shreya', 'shreya', 'Female', '7338330769', 'Baroda'),
(8, 'Pratik', 'bithu', 'bithu', 'Male', '12345678', 'Bangalore'),
(9, 'Rithvik', 'Emma', '123', 'Male', '1234567', 'Bangalore'),
(10, 'Siri', 'siri', '1234', 'Female', '7338330769', 'Bangalore');
...
--
ALTER TABLE `subcat`
  MODIFY `subcat_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
